...
namespace AutoHouse
{
    public partial class AquecimentoUser : Form
    {
        public AquecimentoUser()
        {
            InitializeComponent();
        }
        // botao voltar
        ...
        {
            Casadebanhosegundo cs = new Casadebanhosegundo();
            this.Hide();
            cs.Show();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                button3.Text = "Aquecimento está desligado. Clique para ligar";
            }
            else if (button3.Text == "Aquecimento está desligado. Clique para ligar")
            {
